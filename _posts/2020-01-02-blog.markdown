...
> ![GitHub 레파지토리 만들기](/public/img/git레파지토리 만들기.png)
...
> ![Git 주소 확인](/public/img/git주소.png)
...
11. 서버가 정상적으로 실행되면, 아래와 같은 문구를 확인할 수 있습니다. 로컬 주소(http://127.0.0.1:4000/)로 접속합니다:<br>
    ![로컬 실행](/public/img/로컬실행.png)<br>
    로컬 실행화면: <br>
    ![로컬 실행 화면](/public/img/로컬실행화면.png)
